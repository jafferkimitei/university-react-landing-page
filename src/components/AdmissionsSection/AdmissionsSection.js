      ...
      <div className="admissions-content">
        ...
        <div className="application-process">
          ...
          <ul className="process-steps">
            <li>
              <strong>Step 1:</strong> Complete the online application form on our website.
            </li>
            <li>
              <strong>Step 2:</strong> Submit required academic transcripts and documents.
            </li>
            <li>
              <strong>Step 3:</strong> Submit your personal statement or motivation letter.
            </li>
            <li>
              <strong>Step 4:</strong> Provide letters of recommendation (if required).
            </li>
            <li>
              <strong>Step 5:</strong> Attend an interview (for selected candidates).
            </li>
            <li>
              <strong>Step 6:</strong> Receive admission decision and final instructions.
            </li>
          </ul>
